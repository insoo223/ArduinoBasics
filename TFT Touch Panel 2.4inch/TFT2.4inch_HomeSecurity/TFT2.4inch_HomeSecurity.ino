...
void setup(void) {
  ...
  for (i=0; i<3; i++)
    ...
    tft.drawString(BOXSIZE*0, BOXSIZE + 10, "Home Security Pad", WHITE, 2); 
...
void showInsooInfo()
{
  switch (pressedChar)
  {
    case '1'://email
      tft.fillScreen(BLACK);
      //delay(500);
      tft.drawString(showInfo_X,showInfo_Y,"Door", WHITE, 4);
      tft.drawString(showInfo_X,showInfo_Y+showInfo_deltaY,"Access", WHITE, 4);
      tft.drawString(showInfo_X,showInfo_Y+(2*showInfo_deltaY),"Code", WHITE, 4);
      break;
    case '2'://mobile
      tft.fillScreen(BLACK);
      //delay(500);
      tft.drawString(showInfo_X,showInfo_Y,"Burglar Alarm", WHITE, 3);
      break;
    case '3'://office tel
      tft.fillScreen(BLACK);
      //delay(500);
      tft.drawString(showInfo_X,showInfo_Y,"Gas Valve", WHITE, 3);
      break;
  }  
}//showInsooInfo
