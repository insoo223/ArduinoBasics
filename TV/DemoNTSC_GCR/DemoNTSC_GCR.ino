...
void loopRun()
{
  ...
  TV.println("Welcom to GCR TVout\nShow running on GCRduino\n");
  TV.delay(2500);
  TV.println("Generate a PAL\nor NTSC composite  video using\ninterrupts\n");
  TV.delay(2500);
  TV.println("The schematic:");
  TV.delay(1500);
  ...
  TV.println("4x6 font GCR");
  TV.select_font(font6x8);
  TV.println("6x8 font GCR");
  TV.select_font(font8x8);
  TV.println("8x8 font GCR");
  TV.select_font(font6x8);
  TV.delay(2000);
