...
void setup(void) {
  ...
  tft.println(scrW);
  tft.setCursor(10, 20);
  tft.print("10,20: scrH ");
  tft.println(scrH);
  
  for (i=40; i<= (320-20); i=i+20)
  {
    tft.setCursor(10, i);
    tft.print("10,");
    tft.println(i);
  }
  tft.drawHorizontalLine(0, 0, scrW, GREEN);
  tft.drawVerticalLine(0, 0, scrH, GREEN);
  tft.drawHorizontalLine(scrW-1, scrH-1, scrW, GREEN);
  tft.drawVerticalLine(scrW-1, scrH-1, scrH, GREEN);
  pinMode(10, OUTPUT);
